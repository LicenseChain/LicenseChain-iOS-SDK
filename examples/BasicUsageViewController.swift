...
/**
 * LicenseChain iOS SDK - Basic Usage Example
 * 
 * This example demonstrates basic usage of the LicenseChain iOS SDK
...
class BasicUsageViewController: UIViewController {
    ...
    private func initializeLicenseChain() {
        print("🚀 LicenseChain iOS SDK - Basic Usage Example")
